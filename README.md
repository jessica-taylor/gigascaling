...
2. [Small World Sharding](./small_world_sharding/small_world_shardingpdf), a method that breaks the blockchain into multiple shards that reference each other.
